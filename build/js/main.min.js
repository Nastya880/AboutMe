...
var _initSwiperEducation = require("./modules/initSwiperEducation");
...
var burgerBtn = document.querySelector('[data-nav-btn-open]');
var closeBtn = document.querySelector('[data-nav-btn-close]');
var menuLinks = document.querySelectorAll('[data-nav-link]');
var switchToggle = document.querySelector('.switch input[type="checkbox"]');
...
function toggleDarkTheme() {
  var isDark = switchToggle.checked;
  body.classList.toggle('dark', isDark);
  localStorage.setItem('darkTheme', isDark ? 'on' : 'off');
}
switchToggle.addEventListener('change', toggleDarkTheme);
window.addEventListener('load', function () {
  var isDark = localStorage.getItem('darkTheme') === 'on';
  body.classList.toggle('dark', isDark);
  switchToggle.checked = isDark;
});
burgerBtn.addEventListener('click', openHeaderNav);
closeBtn.addEventListener('click', closeHeaderNav);
(0, _initSwiperEducation.initSwiperEducation)();

},{"./modules/initSwiperEducation":2}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initSwiperEducation = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initSwiperEducation = exports.initSwiperEducation = function initSwiperEducation() {
  var swiper = new _swiper.default('[data-swiper="education"]', {
    loop: true,
    navigation: {
...
},{"../vendor/swiper":3}],3:[function(require,module,exports){
